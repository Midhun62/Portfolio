...
export default function Home() {
  ...
  const dataText = ["MIDHUN M", "Web Developer"];

  // for scroll function useeffect
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 0) {
        setIsScrolled(true);
    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40 pt-20">
        <section id='home' className="min-h-screen">
          ...
          <div className="relative mx-auto w-78 h-78 md:w-56 md:h-56 mt-20">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              ...
              <a href="http://www.youtube.com/@TechMasterAITut" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF0000] dark:hover:text-[#FF0000] transition-colors">
                <AiFillYoutube />
              </a>
            </div>
          </div>
        </section>
        <section id="about" className="py-10 mb-16">
          <div className="max-w-7xl mx-auto px-4">
            <h3 className="text-3xl py-1 dark:text-white pb-8">About Me</h3>
            <div className="text-xl dark:text-white">I am a frontend web developer with a passion for creating interactive and responsive web applications. I have experience working with HTML, CSS, JavaScript, React, Mysql and Git. I am a quick learner and I am always looking to expand my knowledge and skill set. I am a team player and I am excited to work with others to create amazing applications.
              {/* techniology cards */}
